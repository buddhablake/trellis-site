      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        <ScrollReveal>
          ...
          <p className="text-lg text-cream/80 mb-8">
            Take the first step towards authentic business growth with our Cultivate Assessment.
            It's free, takes just 15-20 minutes, and could transform how you see your business.
          </p>
          <AssessmentDialog 
